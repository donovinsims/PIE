...
export const metadata = {
  title: "Pietro's Pizzeria Party Trays Menu | Roscoe, IL",
  description: "Order Pietro's Pizzeria party trays in Roscoe, IL. Perfect for gatherings, events, and family meals — available for carry out or delivery.",
};
